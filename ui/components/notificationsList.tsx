...
const NotificationsList = () => {
	...
	const messageTypes: any = {
		"issued": { title: "Credential Issued", getMessage: (notification: any) => `You have been issued a credential by ${AddressExtensions.getShortAddress(notification.owner)}` },
				...
				{notifications.map((notification: any, index: number) => (
					<div key={index} className="grid card">
						...
						<div className="card-actions mt-2">
							...
							<p className='text-xs'>
								<DateDisplay date={notification.created} /></p>
						</div>
